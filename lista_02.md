...
Classe Veiculo:
    ...
    Método CalcularConsumo():
        Retornar "Cálculo de consumo genérico"

Classe Carro Herda Veiculo:
    Atributos Adicionais:
        capacidadeTanque: Real
        consumoKmPorLitro: Real

    Método Construtor(modelo, ano, capacidadeTanque, consumoKmPorLitro):
        Chamar Construtor da Classe Pai(modelo, ano)
        Este.capacidadeTanque <- capacidadeTanque
        Este.consumoKmPorLitro <- consumoKmPorLitro

    Método CalcularConsumo(distanciaPercorrida: Real):
        combustivelGasto <- distanciaPercorrida / Este.consumoKmPorLitro
        Se (combustivelGasto > Este.capacidadeTanque) então
            Retornar "Necessário reabastecer"
        Senão
            Retornar combustivelGasto
...
Classe Moto Herda Veiculo:
    ...
    Método Construtor(modelo, ano, cilindrada, consumoKmPorLitro):
        Chamar Construtor da Classe Pai(modelo, ano)
